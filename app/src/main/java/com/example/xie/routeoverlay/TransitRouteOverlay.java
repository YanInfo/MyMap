...
public class TransitRouteOverlay extends OverlayManager {
    ...
    private BitmapDescriptor getIconForStep(TransitRouteLine.TransitStep step) {
        switch (step.getStepType()) {
            case BUSLINE:
                return getBuslineIcon() != null ? getBuslineIcon() : BitmapDescriptorFactory.fromAssetWithDpi("Icon_bus_station.png");
            case SUBWAY:
                return getSubwayIcon() != null ? getSubwayIcon() : BitmapDescriptorFactory.fromAssetWithDpi("Icon_subway_station.png");
            case WAKLING:
                return getWalkingIcon() != null ? getWalkingIcon() : BitmapDescriptorFactory.fromAssetWithDpi("Icon_walk_route.png");
            default:
                return null;
        }
    }
